...
namespace AlbanianXrm.XrmToolBox.ExampleTool
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "Example Tool"),
        ExportMetadata("Company", "AlbanianXrm"),
        ExportMetadata("Description", "This tool serves as a test harness for AlbanianXrm.XrmToolBox.Shared"),
    ...
    public class MyTool : PluginBase
    {
        public override IXrmToolBoxPluginControl GetControl()
        {
            return new MyToolControl();
        }
